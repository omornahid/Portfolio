  ...
  state: () => ({
    cards: {
      ...
      movihuv: {
        ...
        description:
          "It's a movie app where people can see the trending movie list and can search for a movie. Here I used React Hooks, Bootstrap and fetched data from an API ",
